...
const int NUMWEQ = 17;
const int NUMEEQ = 75;
const int NUMEQ = NUMWEQ + NUMEEQ +10 + 8 + 1 + 8 + 3 + 2; // Q. Z. 10 for soil thermal model //add 8 variables for N cycle YYL //added 8 variable for N2O uptake by YYuan //added 3 N2fix //added 2 vegcag,vegcbg
const int MAXWSTAT = 7;
const int MAXESTAT = 18 + 2 + 1 + 2 ; //add NH4 and NO3 for N cycle by YYL; added DOC by YYL; add VEGCAG, VEGCBG by YYuan
...
class TTEM : public Odeint4 {
  ...
  public:
     ...
     enum temkey { I_VEGC,     I_SOLC,     I_TOTC,     I_VEGN,     I_STRN,
                   ...
                   I_TOTPRDN,  I_TOTEC,    I_TOTGC,		 I_NO3, I_NH4, I_DOC, I_VEGCAG, I_VEGCBG,
                   ...
                   I_N2OF, I_N2F, I_N2OAIR, I_N2AIR, I_N2OUPT, I_N2ON,I_N2ODN,I_NH3, I_N2FIX, I_N2FIXS, I_N2FIXFL};

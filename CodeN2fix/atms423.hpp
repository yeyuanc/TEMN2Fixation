...
//   Climatic Variables
 ...
 //    double sun[CYCLE];         // percent sunshine duration
     ...
     double nhxdepo[CYCLE];   //N deposition
     double tnhxdepo[MAXRTIME][CYCLE]; 
     long nhxdepoyear[MAXRTIME];
     double noydepo[CYCLE];   
     double tnoydepo[MAXRTIME][CYCLE]; 
     long noydepoyear[MAXRTIME];
     ...
     double yrnhxdepo;
     double yrtnhxdepo[MAXRTIME];    //N deposition
     double yrnoydepo;
     double yrtnoydepo[MAXRTIME];      

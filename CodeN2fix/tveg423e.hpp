...
//     void   getvtype(char ecd[80]);
   // modified for thawing STM, hydrology model, adding thawpercent
     ...
     double rsratio(int& dcmnt, double& tair,double& vegc);
...
************************************************************** */
     ...
     Biomass planta[CYCLE];    // aboveground plant biomass
     Biomass plantb[CYCLE];    // belowground plant biomass
     ...
     double yrcarbona;          // annual sum of plant.carbona
     double yrcarbonb;         // annual sum of plant.carbonb
